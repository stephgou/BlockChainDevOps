...
Param(
    ...
    [string] $ResourceGroupName = 'BlockChainPoint',
...
function Format-ValidationOutput {
    param ([Microsoft.Azure.Commands.ResourceManager.Cmdlets.SdkModels.PSResourceManagerError[]] $ValidationOutput, [int] $Depth = 0)
